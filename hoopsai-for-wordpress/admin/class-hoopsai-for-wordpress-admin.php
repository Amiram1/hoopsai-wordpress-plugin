 ...
 * @subpackage Hoopsai_For_Wordpress/admin
 */
 ...
 */
class Hoopsai_For_Wordpress_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $hoopsai_for_wordpress       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->hoopsai_for_wordpress, plugin_dir_url( __FILE__ ) . 'css/hoopsai-for-wordpress-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->hoopsai_for_wordpress, plugin_dir_url( __FILE__ ) . 'js/hoopsai-for-wordpress-admin.js', array( 'jquery' ), $this->version, false );
